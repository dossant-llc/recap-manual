...
A: Any headset that works with your phone. Test it first by plugging directly into your phone and making a call. Apple EarPods work well as a reference.
...
A: Yes, in Audacity. Record in stereo, then use "Split Stereo Track" to separate left (your voice) and right (their voice) into separate files.
